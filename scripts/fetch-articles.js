...
const FALLBACK_TOPICS = [
  { title: 'Хронический простатит: основные симптомы и когда обращаться к урологу', category: 'Простатит и аденома', source_name: 'УроЗдоровье', source_url: 'https://urozdorovie.local/' },
  { title: 'Аденома простаты: как отличить возрастные изменения от патологии', category: 'Простатит и аденома', source_name: 'УроЗдоровье', source_url: 'https://urozdorovie.local/' },
  { title: 'Профилактика простатита: простые привычки для мужского здоровья', category: 'Лечение и профилактика', source_name: 'УроЗдоровье', source_url: 'https://urozdorovie.local/' },
  { title: 'Анализ ПСА: что означают цифры и когда нужна биопсия', category: 'Лечение и профилактика', source_name: 'УроЗдоровье', source_url: 'https://urozdorovie.local/' },
  { title: 'Застойный простатит: причины, симптомы и тактика лечения', category: 'Простатит и аденома', source_name: 'УроЗдоровье', source_url: 'https://urozdorovie.local/' },
  { title: 'Частое мочеиспускание у мужчин: когда это признак проблем с простатой', category: 'Урология', source_name: 'УроЗдоровье', source_url: 'https://urozdorovie.local/' },
  { title: 'Тур простаты: показания, этапы восстановления и ограничения', category: 'Лечение и профилактика', source_name: 'УроЗдоровье', source_url: 'https://urozdorovie.local/' },
  { title: 'Эректильная дисфункция и простатит: есть ли связь', category: 'Мужское здоровье', source_name: 'УроЗдоровье', source_url: 'https://urozdorovie.local/' },
  { title: 'Массаж простаты: показания и противопоказания', category: 'Лечение и профилактика', source_name: 'УроЗдоровье', source_url: 'https://urozdorovie.local/' },
